class Api::Speaker2::UsersController < ApplicationController
  ...
  def show
    @speakers = @user.speakers.find_by_sorting(2)
    @user = User.first
    render :show
  end
