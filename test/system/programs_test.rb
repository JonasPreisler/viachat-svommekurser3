...
class ProgramsTest < ApplicationSystemTestCase
  ...
  test "creating a Program" do
    ...
    fill_in "Endtime", with: @program.endtime
    fill_in "Name", with: @program.name
    fill_in "Place", with: @program.place_id
    fill_in "Speaker", with: @program.speaker_id
    fill_in "Startday", with: @program.startday
    fill_in "Starttime", with: @program.starttime
