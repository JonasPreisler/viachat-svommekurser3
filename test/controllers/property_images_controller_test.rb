...
class PropertyImagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create property_image" do
    assert_difference('PropertyImage.count') do
      post property_images_url, params: { property_image: { image: @property_image.image, property_id: @property_image.property_id } }
    end
  ...
  test "should update property_image" do
    patch property_image_url(@property_image), params: { property_image: { image: @property_image.image, property_id: @property_image.property_id } }
