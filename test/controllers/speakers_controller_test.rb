...
class SpeakersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create speaker" do
    assert_difference('Speaker.count') do
      post speakers_url, params: { speaker: { address: @speaker.address, description: @speaker.description, image: @speaker.image, price: @speaker.price } }
    end
  ...
  test "should update speaker" do
    patch speaker_url(@speaker), params: { speaker: { address: @speaker.address, description: @speaker.description, image: @speaker.image, price: @speaker.price } }
