...
class DaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create day" do
    assert_difference('Day.count') do
      post days_url, params: { day: { date: @day.date, event_id: @day.event_id, program_id: @day.program_id } }
    end
  ...
  test "should update day" do
    patch day_url(@day), params: { day: { date: @day.date, event_id: @day.event_id, program_id: @day.program_id } }
