...
class PlacesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create place" do
    assert_difference('Place.count') do
      post places_url, params: { place: { name: @place.name, program_id: @place.program_id } }
    end
  ...
  test "should update place" do
    patch place_url(@place), params: { place: { name: @place.name, program_id: @place.program_id } }
